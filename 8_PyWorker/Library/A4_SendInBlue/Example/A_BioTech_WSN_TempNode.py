...
# mailConfig.to  = MAIL_TO_ALL  = [{"email":'dhcuong1975@yahoo.com.vn'},{"email":'tran.dung@cmengineering.com.vn',"name":"Tran Dung"},{"email":'nguyen.phuc@cmengineering.com.vn',"name":"Nguyen Phuc"},{"email":'phan.tien@cmengineering.com.vn',"name":"Phan Tien"}]

# mailConfig.to  = MAIL_TO_ALL  = [{"email":'tran.dung@cmengineering.com.vn',"name":"Tran Dung"}]
mailConfig.subject = "CẢNH BÁO: PIN YẾU - TRẠM GIÁM SÁT 6"
...
file = open("D:/Database/GIT/LOTUS_Python_Framework/A_BioTech_tempNodeAlert.html", encoding="utf8")
