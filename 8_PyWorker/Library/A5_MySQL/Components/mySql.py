...
class mySqlClass ():
  #0. Init MySQL
  def __init__(self,hostAddress:str="200.200.200.1",username="root",password="",database="tiktop_gx",hostVpnAddress:str="",hostDdnsUrl:str=""):
    ### Private Functions ###
